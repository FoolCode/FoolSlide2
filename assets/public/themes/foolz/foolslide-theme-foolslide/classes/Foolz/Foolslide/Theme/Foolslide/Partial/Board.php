...
class Board extends \Foolz\Foolslide\View\View
{
    public function toString()
    {
        ...
        <article id="<?= $num ?>" class="clearfix thread doc_id_<?= $op->doc_id ?> board_<?= $op->radix->shortname ?>" data-doc-id="<?= $op->doc_id ?>" data-thread-num="<?= $op->thread_num ?>">
                ...
                <?php endif; ?>
                <?php \Foolz\Plugin\Hook::forge('foolslide.themes.default_after_op_open')->setObject($this)->setParam('board', $op->radix)->execute(); ?>
        ...
        <article class="clearfix thread">
                    <?php \Foolz\Plugin\Hook::forge('foolslide.themes.default_after_headless_open')->setObject($this)->setParam('board', array(isset($radix) ? $radix : null))->execute(); ?>
                <?php endif; ?>
