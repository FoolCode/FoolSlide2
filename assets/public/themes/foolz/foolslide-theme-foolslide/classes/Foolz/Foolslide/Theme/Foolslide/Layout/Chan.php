...
class Chan extends \Foolz\Foolslide\View\View
{
...
<head>
    <meta charset="utf-8">
    <meta name="generator" content="<?= $this->getConfig()->get('foolz/foolslide', 'package', 'main.name').' '.$this->getConfig()->get('foolz/foolslide', 'package', 'main.version') ?>">
    ...
    <![endif]-->
    <?php if ($this->getPreferences()->get('foolslide.sphinx.global')) : ?>
                ...
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <ul class="nav">
                            ...
                            $top_nav = \Foolz\Plugin\Hook::forge('foolslide.themes.default_top_nav_buttons')->setObject($this)->setParam('nav', $top_nav)->execute()->get($top_nav);
    ...
    public function getContent()
    {
        ...
        <div role="main" id="main">
            ...
            <?php \Foolz\Plugin\Hook::forge('foolslide.themes.default_after_body_template')->setObject($this)->execute(); ?>
    ...
    public function getFooter()
    {
        ?>
    <footer id="footer">
        <a href="https://github.com/FoolCode/Foolslide"><?= $this->getConfig()->get('foolz/foolslide', 'package', 'main.name') ?>
            Imageboard <?= $this->getConfig()->get('foolz/foolslide', 'package', 'main.version') ?></a>
        ...
        $bottom_nav = \Foolz\Plugin\Hook::forge('foolslide.themes.default_bottom_nav_buttons')->setObject($this)->setParam('nav', $bottom_nav)->execute()->get($bottom_nav);
