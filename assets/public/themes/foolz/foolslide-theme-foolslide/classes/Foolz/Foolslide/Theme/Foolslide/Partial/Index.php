...
class Index extends \Foolz\Foolslide\View\View
{
    public function toString()
    {
    ?>
        <nav class="index_nav clearfix">
        <h1><?= $this->getPreferences()->get('foolslide.gen_index_title'); ?></h1>
        <?php
            ...
            $index_nav = Hook::forge('foolslide.themes.default.index_nav_elements')->setObject($this)->setParam('nav', $index_nav)->execute()->get($index_nav);
